...
bool test_BSTInit(Node *TempTree)			{
	BSTInit(TempTree);
    Print_tree(*TempTree);
	return true;
}

bool test_BSTSearch (Node TempTree, string Key)	{
	Node FOUND;
...
bool test_isDeclared (Node TempTree, string Key)	{
	bool FOUND;
...
bool test_getType (Node TempTree, string Key)	{
	int FOUND;
...
bool test_BSTInsert (Node *TempTree, string Key, int Type)		{
...
/*
int test_BSTDelete (NodePtr* TempTree, char K)		{
...
int test_BSTDispose(Node* TempTree)		{
	BSTDispose(TempTree);
	Print_tree(*TempTree);
	return true;
...
Node TempTree;			/* deklarace testovaci promenne */ 
